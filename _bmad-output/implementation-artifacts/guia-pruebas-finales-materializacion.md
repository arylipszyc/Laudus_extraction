...
es idempotente (sobrescribe el mismo archivo por slug), así que un reintento no duplica.

## Paso 0 — Confirmar que el deploy está live

Antes de nada, confirmá que Render terminó de deployar el commit `d52480e` (o posterior). Si tenés acceso
...
| Latanpass 0858 USD | T/C: 0858 - Visa Latanpass - US$ | usd 02, 03 | postea con BCCh |
