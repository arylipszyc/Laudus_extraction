...
### Read Access
- `C:\dev\bmad-workspace-new\family-office-eag/` — conciencia general del proyecto

### Write Access
- `C:\dev\bmad-workspace-new\family-office-eag\_bmad\memory\agent-contadora/` — sanctum completo, lectura y escritura
