...
- FFCC = caja de los fondos familiares; reparte a AAG/EAG/DAG (hijos de JAB), AZBA (4 nietos, hijos de SAG = la hija fallecida) y FGK (viuda). "JAB" en cuentas = FGK en la práctica → **label de 11.2 a decidir por Ary (¿JAB o FGK?)**.
...
- **Watchlist post-import (8 ítems, §4 del artefacto)** — DIFERIDA por Ary a cuando los números estén en Beancount. Pregunta de negocio del reporte 13.1 ampliada: (a) en qué gasta el fondo/FGK por activo + (b) cuánto repartió y a quién.
